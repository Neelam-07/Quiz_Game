...
class QuizInterface():
    def __init__(self, quiz_brain:QuizBrain):
        ...
        self.question_text= self.canvas.create_text(150, 125,width=280, text= "ghbjb", font= FONT, fill=THEME_COLOR)
        self.canvas.grid(row= 1, column=0, columnspan=2, pady=50)

        self.true_pic= PhotoImage(file= "./Day_34_API_prac/images/true.png")
        self.true_button= Button(image=self.true_pic, highlightthickness=0, command= self.true_pressed)
        self.true_button.grid(row= 2, column= 0)

        self.false_pic= PhotoImage(file= "./Day_34_API_prac/images/false.png")
